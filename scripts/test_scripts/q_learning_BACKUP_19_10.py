...
# Motoren aktivieren und auf "Spannung" bringen
...
# Initialisierung der Motoren-Ports
...
learning_rate, discount_factor, exploration_rate = 0.1, 0.95, 1.0
max_exploration_rate, min_exploration_rate, exploration_decay_rate = 1.0, 0.01, 0.01
